...
#ansible-playbook -i inventory/inventory.yml --tags "postgresql_switchover_to_standby_node" --extra-vars "postgresql_standby_node_for_switchover=vm1" --user=edele postgresql_ha_cascade.yml

# Cluster status
#ansible-playbook -i inventory/inventory.yml --tags "postgresql_cluster_status" --user=edele postgresql_ha_cascade.yml

# Cluster stop
#ansible-playbook -i inventory/inventory.yml --tags "postgresql_cluster_stop" --user=edele postgresql_ha_cascade.yml
...
ansible-playbook -i inventory/inventory.yml --tags "postgresql_cluster_replication_status" --user=edele postgresql_ha_cascade.yml